...
class StudentDetails(db2.Model):
	...
	#New_Columns
	hacker_rank=db2.Column(db2.String(45),nullable=True)
	codeforces=db2.Column(db2.String(45),nullable=True)
	hacker_earth=db2.Column(db2.String(45),nullable=True)
...
class Student_files(db2.Model):
	__bind_key__="Students"
	__tablename__="Student_files"
	student_name=db2.Column(db2.String(30),primary_key=True)
	file_name=db2.Column(db2.String(70))
	file_path=db2.Column(db2.String(70))

class Teacher_notify(db1.Model):
	__bind_key__="Teachers"
	__tablename__="Teacher_notify"
	teacher_name=db2.Column(db2.String(30),primary_key=True)
	student_name=db2.Column(db2.String(70))
	file_path=db2.Column(db2.String(70))